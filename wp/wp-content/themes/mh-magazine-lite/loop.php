...
<article <?php post_class(); ?>>
	<div class="loop-wrap clearfix hello">
		...
		<header class="loop-data">
			...
			<p class="meta"><a href="<?php the_permalink()?>" rel="bookmark"><?php $date = get_the_date(); echo $date; ?></a> // 
			<!-- <?php comments_number(__('0 Comments', 'mh-magazine-lite'), __('1 Comment', 'mh-magazine-lite'), __('% Comments', 'mh-magazine-lite')); ?> -->
			</p>
		</header>
		<?php the_excerpt(); ?>
	</div>
