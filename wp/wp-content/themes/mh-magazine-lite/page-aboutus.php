...
//     		mh_before_page_content();
    		while (have_posts()) : the_post(); ?>
				...
				<div id="post-multimedia-holder">
					<div class="icon about"><img src="<?php echo get_bloginfo('template_directory');?>/images/av_icons_VIDEO.png" /></div>
					<h2 class="podcast about tabletGothic uppercase">VIDEO</h2>
					<div class="multimedia-divider"></div>
					
						<?php if ( get_post_meta( get_the_ID(), 'about-excerpt', true ) ) : ?>    
						<p class="about excerpt"> <?php echo get_post_meta( get_the_ID(), 'about-excerpt', true ) ; ?></p> 															<?php endif; ?>
