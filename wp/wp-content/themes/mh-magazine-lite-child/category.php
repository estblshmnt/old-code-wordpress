				...
				<?php 
					if ($counter==1) {  ?>
						<a href="<?php the_permalink();?>"> 
								<h1 class="entry-title feature category_<?php echo $cat_id?>"><span class="halfbackground"><?php the_title(); ?></span></h1>
								<div class="entry-image"><?php the_post_thumbnail( 'EST-SingleLarge' ); ?>
								
								</div>
								<div class="entry-divider"></div>
								<header class="archive-header">
								<h2 class="lower-grid-header tabletGothic uppercase"><?php single_cat_title( '', true ); ?></h2></a>
