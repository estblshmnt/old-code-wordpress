...
/* 						$post_ID= */	  wpp_get_mostpopular('cat=17&pid="128"&range=weekly&order_by=views&limit=5&excerpt_length=355&stats_views=0&post_type=post&stats_author=1&thumbnail_width=1160&thumbnail_height=650&post_html="<li><p>{thumb}{title}<br /><span>by {author}</span><br />{excerpt}</p></li>"');
